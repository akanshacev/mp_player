...
import { uploadVideo } from '../Services1/allApis';
import { toast } from 'react-toastify'
import 'react-toastify/dist/ReactToastify.css';

function Addvedio({setAddStatus}) {
                ...
                <Modal.Body>
                    <Form>
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                            ...
                            <Form.Control type="text" name='caption' onChange={(e) => { getdata(e) }} placeholder="Enter Your Caption" />
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput2">
                            <Form.Label>Vedio URL</Form.Label>
                            <Form.Control type="text" name='url' onChange={(e) => { getdata(e) }} placeholder="Enter Youtube Vedio URL" />
                        </Form.Group>
